...
def move_to(event_x, event_y, rectangle_id, first, last):
    ...
    new_upper_left_corner = _calculate_new_upper_left_corner_of_the_rectangle(
        event_x, event_y, edge_length
    )
    new_lower_right_corner = _calculate_new_lower_right_corner_of_the_rectangle(
        event_x, event_y, edge_length
    )
    _move_rectangle_in_canvas(
