...
def create_control_notebook_tab() -> None:
    ...
    _select_file_number_frame.grid(row=3, column=1, sticky="w")
...
= File with Entity and Architecture\n$name\t= Module Name",
    ...
    include_timestamp_label.grid(row=13, column=0, sticky="w")
    include_timestamp_checkbox.grid(row=13, column=1, sticky="w")
