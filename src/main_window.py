...
def create_menu_bar() -> None:
    ...
    file_menu.add_command(label="New", accelerator="Ctrl+n", command=file_handling.clear_design(), font=("Arial", 10))
    ...
    root.bind_all("<Control-n>", lambda event: file_handling.clear_design())
