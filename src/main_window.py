...
= File with Entity and Architecture\n$name\t= Module Name",
    ...
    additional_sources_entry.grid(row=9, column=1, sticky=tk.EW)
    additional_sources_button.grid(row=9, column=2, sticky=tk.EW)
    ...
    working_directory_entry.grid(row=10, column=1, sticky=tk.EW)
    working_directory_button.grid(row=10, column=2, sticky=tk.EW)
    ...
    diagram_background_color_entry.grid(row=11, column=1, sticky=tk.EW)
    diagram_background_color_button.grid(row=11, column=2, sticky=tk.EW)
