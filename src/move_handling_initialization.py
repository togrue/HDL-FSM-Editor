...
def _move_initialization_overlapping(event, event_x, event_y):
    items_near_mouse_click_location = (
        _create_a_list_of_overlapping_items_near_the_mouse_click_location(
            event_x, event_y
        )
    )
...
def _create_move_list(items_near_mouse_click_location, event_x, event_y):
    ...
    move_list_entry_for_diagram_object = (
        _create_move_list_entry_if_a_diagram_object_is_moved(
            items_near_mouse_click_location
        )
    )
...
def _create_move_list_entry_if_a_diagram_object_is_moved(
    items_near_mouse_click_location,
):
    ...
    if transition_tags != ():
        ...
        for tag in transition_tags:
            if tag.startswith("transition"):
                ...
                _remove_tags_and_hide_priority(
