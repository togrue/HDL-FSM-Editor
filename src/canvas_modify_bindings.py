...
def switch_to_state_action_default_insertion():
    ...
    main_window.canvas.bind(
        "<Button-1>", global_actions_handling.insert_state_actions_default
    )
...
def switch_to_global_action_clocked_insertion():
    ...
    main_window.root.config(cursor="bogosity")
    main_window.canvas.bind(
        "<Button-1>", global_actions_handling.insert_global_actions_clocked
    )
...
def switch_to_global_action_combinatorial_insertion():
    ...
    main_window.root.config(cursor="bogosity")
    main_window.canvas.bind(
        "<Button-1>", global_actions_handling.insert_global_actions_combinatorial
    )
