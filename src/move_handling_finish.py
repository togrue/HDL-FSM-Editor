...
def _moving_of_transition_start_or_end_point_ends_at_illegal_place(item_ids_at_moving_end_location, move_list):
...
def _update_the_tags_of_the_transition(item_ids_at_moving_end_location, transition_id, transition_point):
...
def _a_point_of_a_line_is_moved_illegally_to_a_reset_entry(item_ids_at_moving_end_location, move_list):
    for target in item_ids_at_moving_end_location:
...
def _transition_connects_reset_entry_and_connector(item_ids_at_moving_end_location, move_list):
    for target in item_ids_at_moving_end_location:
