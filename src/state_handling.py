...
def draw_state_circle(coords, color, tags) -> int:
    state_id = project_manager.canvas.create_oval(
        coords,
        fill=color,
        width=2,
        outline="blue",
    ...
    project_manager.canvas.tag_bind(
        state_id, "<Enter>", lambda event, id=state_id: project_manager.canvas.itemconfig(id, width=4)
    )
    project_manager.canvas.tag_bind(
        state_id, "<Leave>", lambda event, id=state_id: project_manager.canvas.itemconfig(id, width=2)
    )
    project_manager.canvas.tag_bind(state_id, "<Button-3>", lambda event, id=state_id: show_menu(event, id))
    project_manager.canvas.tag_bind(
        state_id,
        "<Button-1>",
