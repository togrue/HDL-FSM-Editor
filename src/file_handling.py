...
def save_as():
    global filename, _filename_old
    _filename_old = filename
    ...
    for line in fileobject:
        if line.startswith("modulename|"):
            ...
            rest_of_line = _remove_keyword_from_line(
                line, "internals_process_combinatorial|"
            )
            data = _get_data(rest_of_line, fileobject)
            ...
            condition_action_handling.ConditionAction.conditionaction_id = int(
                rest_of_line
            )
            ...
            rest_of_line = _remove_keyword_from_line(
                line, "state_actions_default_number|"
            )
            ...
            rest_of_line = _remove_keyword_from_line(
                line, "global_actions_combinatorial_number|"
            )
            global_actions_handling.global_actions_combinatorial_number = int(
                rest_of_line
            )
            ...
            main_window.canvas.tag_bind(
                state_id,
                "<Enter>",
                lambda event, id=state_id: main_window.canvas.itemconfig(id, width=4),
            )
            main_window.canvas.tag_bind(
                state_id,
                "<Leave>",
                lambda event, id=state_id: main_window.canvas.itemconfig(id, width=2),
            )
            main_window.canvas.tag_bind(
                state_id,
                "<Button-3>",
                lambda event, id=state_id: state_handling.show_menu(event, id),
            )
            ...
            polygon_id = main_window.canvas.create_polygon(
                coords, fill="red", outline="orange", tags=tags
            )
            main_window.canvas.tag_bind(
                polygon_id,
                "<Enter>",
                lambda event, id=polygon_id: main_window.canvas.itemconfig(id, width=2),
            )
            main_window.canvas.tag_bind(
                polygon_id,
                "<Leave>",
                lambda event, id=polygon_id: main_window.canvas.itemconfig(id, width=1),
            )
            ...
            for t in tags:
                if t.startswith("transition"):
                    main_window.canvas.tag_bind(
                        ...
                        "<Double-Button-1>",
                        lambda event,
                        transition_tag=t[:-8]: transition_handling.edit_priority(
                    ...
                    main_window.canvas.tag_bind(
                        text_id,
                        "<Double-Button-1>",
                        lambda event, text_id=text_id: state_handling.edit_state_name(
                            event, text_id
                        ),
                    )
            ...
            trans_id = main_window.canvas.create_line(
                coords, smooth=True, fill="blue", tags=tags
            )
            main_window.canvas.tag_lower(
                trans_id
            )  # Lines are always "under" the priority rectangles.
            main_window.canvas.tag_bind(
                trans_id,
                "<Enter>",
            ...
            for t in tags:
                if t.startswith("connected_to_transition"):
                    main_window.canvas.itemconfig(
                        trans_id, dash=(2, 2), state=tk.HIDDEN
                    )
                    ...
                    main_window.canvas.tag_bind(
                        trans_id,
                        "<Button-3>",
                        lambda event, id=trans_id: transition_handling.show_menu(
                            event, id
                        ),
                    )
            ...
            canvas_id = main_window.canvas.create_rectangle(
                coords, tag=tags, fill=rectangle_color
            )
            main_window.canvas.tag_raise(
                canvas_id
            )  # priority rectangles are always in "foreground"
            ...
            rest_of_line = _remove_keyword_from_line(
                line, "window_condition_action_block|"
            )
            ...
            rest_of_line = _remove_keyword_from_line(
                line, "window_global_actions_combinatorial|"
            )
            text = _get_data(rest_of_line, fileobject)
            coords = []
            tags = ()
            ...
            rest_of_line = _remove_keyword_from_line(
                line, "window_state_actions_default|"
            )
            text = _get_data(rest_of_line, fileobject)
            coords = []
            tags = ()
...
def _print_canvas():
    ...
    print_filename = (
        main_window.generate_path_value.get()
        + "/"
        + main_window.module_name.get()
        + ".eps"
    )
...
def save_in_file_new(
    save_filename,
):  # Called at saving and at every design change (writing to .tmp-file)
    design_dictionary = {}
    ...
    design_dictionary["diagram_background_color"] = (
        main_window.diagram_background_color.get()
    )
    ...
    design_dictionary["conditionaction_id"] = (
        condition_action_handling.ConditionAction.conditionaction_id
    )
    design_dictionary["mytext_id"] = state_action_handling.MyText.mytext_id
    design_dictionary["global_actions_number"] = (
        global_actions_handling.global_actions_clocked_number
    )
    design_dictionary["state_actions_default_number"] = (
        global_actions_handling.state_actions_default_number
    )
    ...
    design_dictionary["interface_package"] = main_window.interface_package_text.get(
        "1.0", tk.END + "-1 chars"
    )
    design_dictionary["interface_generics"] = main_window.interface_generics_text.get(
        "1.0", tk.END + "-1 chars"
    )
    design_dictionary["interface_ports"] = main_window.interface_ports_text.get(
        "1.0", tk.END + "-1 chars"
    )
    design_dictionary["internals_package"] = main_window.internals_package_text.get(
        "1.0", tk.END + "-1 chars"
    )
    design_dictionary["internals_architecture"] = (
        main_window.internals_architecture_text.get("1.0", tk.END + "-1 chars")
    )
    design_dictionary["internals_process"] = (
        main_window.internals_process_clocked_text.get("1.0", tk.END + "-1 chars")
    )
    design_dictionary["internals_process_combinatorial"] = (
        main_window.internals_process_combinatorial_text.get("1.0", tk.END + "-1 chars")
    )
    ...
    if main_window.language.get() == "VHDL":
        design_dictionary["regex_message_find"] = (
            main_window.regex_message_find_for_vhdl
        )
    else:
        design_dictionary["regex_message_find"] = (
    ...
    design_dictionary["regex_file_line_number_quote"] = (
        main_window.regex_file_line_number_quote
    )
        ...
        if main_window.canvas.type(i) == "oval":
            design_dictionary["state"].append(
                [
                    ...
                    main_window.canvas.itemcget(i, "fill"),
                ]
            )
            ...
            design_dictionary["text"].append(
                [
                    main_window.canvas.coords(i),
                    main_window.canvas.gettags(i),
                    main_window.canvas.itemcget(i, "text"),
                ]
            )
        elif main_window.canvas.type(
            i
        ) == "line" and "grid_line" not in main_window.canvas.gettags(i):
            design_dictionary["line"].append(
                [main_window.canvas.coords(i), main_window.canvas.gettags(i)]
            )
        elif main_window.canvas.type(i) == "polygon":
            design_dictionary["polygon"].append(
                [main_window.canvas.coords(i), main_window.canvas.gettags(i)]
            )
        elif main_window.canvas.type(i) == "rectangle":
            design_dictionary["rectangle"].append(
                [main_window.canvas.coords(i), main_window.canvas.gettags(i)]
            )
            ...
            if i in state_action_handling.MyText.mytext_dict:
                design_dictionary["window_state_action_block"].append(
                    [
                        main_window.canvas.coords(i),
                        state_action_handling.MyText.mytext_dict[i].text_id.get(
                            "1.0", tk.END + "-1 chars"
                        ),
                        main_window.canvas.gettags(i),
                    ]
                ...
                design_dictionary["window_state_comment"].append(
                    [
                        main_window.canvas.coords(i),
                        state_comment.StateComment.dictionary[i].text_id.get(
                            "1.0", tk.END + "-1 chars"
                        ),
                        main_window.canvas.gettags(i),
                    ]
                ...
                design_dictionary["window_condition_action_block"].append(
                    [
                        ...
                        condition_action_handling.ConditionAction.dictionary[
                            i
                        ].condition_id.get("1.0", tk.END + "-1 chars"),
                        condition_action_handling.ConditionAction.dictionary[
                            i
                        ].action_id.get("1.0", tk.END + "-1 chars"),
                        main_window.canvas.gettags(i),
                    ]
                )
                ...
                design_dictionary["window_global_actions"].append(
                    [
                        main_window.canvas.coords(i),
                        global_actions.GlobalActions.dictionary[i].text_before_id.get(
                            "1.0", tk.END + "-1 chars"
                        ),
                        global_actions.GlobalActions.dictionary[i].text_after_id.get(
                            "1.0", tk.END + "-1 chars"
                        ),
                        main_window.canvas.gettags(i),
                    ]
                ...
                i in global_actions_combinatorial.GlobalActionsCombinatorial.dictionary
            ):
                design_dictionary["window_global_actions_combinatorial"].append(
                    [
                        ...
                        global_actions_combinatorial.GlobalActionsCombinatorial.dictionary[
                            i
                        ].text_id.get("1.0", tk.END + "-1 chars"),
                        main_window.canvas.gettags(i),
                    ]
                )
    ...
    try:
        ...
        fileobject.close()
        if not save_filename.endswith(".tmp") and os.path.isfile(_filename_old + ".tmp"):
            os.remove(_filename_old + ".tmp")
    except Exception as _:
        messagebox.showerror(
            "Error in HDL-FSM-Editor",
            "Writing to file " + save_filename + " caused exception ",
        )
    ...
    try:
        ...
        if "sash_positions" in design_dictionary:
            ...
            if (
                ...
                for key, value in design_dictionary["sash_positions"][
                    "interface_tab"
                ].items():
        ...
        main_window.interface_package_text.insert(
            "1.0", design_dictionary["interface_package"]
        )
        main_window.interface_generics_text.insert(
            "1.0", design_dictionary["interface_generics"]
        )
        main_window.interface_ports_text.insert(
            "1.0", design_dictionary["interface_ports"]
        )
        main_window.internals_package_text.insert(
            "1.0", design_dictionary["internals_package"]
        )
        main_window.internals_architecture_text.insert(
            "1.0", design_dictionary["internals_architecture"]
        )
        main_window.internals_process_clocked_text.insert(
        ...
        if "regex_message_find" in design_dictionary:
            if design_dictionary["language"] == "VHDL":
                main_window.regex_message_find_for_vhdl = design_dictionary[
                    "regex_message_find"
                ]
            else:
                main_window.regex_message_find_for_verilog = design_dictionary[
                    "regex_message_find"
                ]
            main_window.regex_file_name_quote = design_dictionary[
                "regex_file_name_quote"
            ]
            main_window.regex_file_line_number_quote = design_dictionary[
        ...
        reset_entry_handling.reset_entry_number = design_dictionary[
            "reset_entry_number"
        ]
        if reset_entry_handling.reset_entry_number == 0:
            main_window.reset_entry_button.config(state=tk.NORMAL)
        ...
        global_actions_handling.global_actions_clocked_number = design_dictionary[
            "global_actions_number"
        ]
        if global_actions_handling.global_actions_clocked_number == 0:
            main_window.global_action_clocked_button.config(state=tk.NORMAL)
        else:
            main_window.global_action_clocked_button.config(state=tk.DISABLED)
        global_actions_handling.state_actions_default_number = design_dictionary[
            "state_actions_default_number"
        ]
        if global_actions_handling.state_actions_default_number == 0:
            main_window.state_action_default_button.config(state=tk.NORMAL)
        else:
        ...
        canvas_editing.reset_entry_size = int(
            design_dictionary["reset_entry_size"]
        )  # stored as float in dictionary
        canvas_editing.priority_distance = int(
            design_dictionary["priority_distance"]
        )  # stored as float in dictionary
        canvas_editing.fontsize = design_dictionary["fontsize"]
        canvas_editing.state_name_font.configure(size=int(canvas_editing.fontsize))
        canvas_editing.label_fontsize = design_dictionary["label_fontsize"]
        canvas_editing.shift_visible_center_to_window_center(
            design_dictionary["visible_center"]
        )
        ...
        for definition in design_dictionary["state"]:
            ...
            state_id = main_window.canvas.create_oval(
                coords, fill=fill_color, width=2, outline="blue", tags=tags
            )
            main_window.canvas.tag_bind(
                state_id,
                "<Enter>",
        ...
        for definition in design_dictionary["line"]:
            ...
            for t in tags:
                if t.startswith("connected_to_transition"):
                    main_window.canvas.itemconfig(
                        trans_id, dash=(2, 2), fill="black", state=tk.HIDDEN
                    )
        ...
        for definition in design_dictionary["rectangle"]:
            ...
            if rectangle_color == constants.STATE_COLOR:  # priority rectangle
                ...
                main_window.canvas.tag_bind(
                    canvas_id,
                    "<Enter>",
                    lambda event, id=canvas_id: main_window.canvas.itemconfig(
                        id, width=2
                    ),
                )
                main_window.canvas.tag_bind(
        ...
        for definition in design_dictionary["window_state_action_block"]:
            ...
            main_window.canvas.itemconfigure(action_ref.window_id, tag=tags)
        if (
            "window_state_comment" in design_dictionary
        ):  # HDL-FSM-versions before 4.2 did not support state-comments.
            for definition in design_dictionary["window_state_comment"]:
                coords = definition[0]
                text = definition[1]
                tags = definition[2]
                comment_ref = state_comment.StateComment(
                    coords[0] - 100, coords[1], height=1, width=8, padding=1
                )
        ...
        for transition_identifer in hide_priority_rectangle_list:
            main_window.canvas.itemconfigure(
                transition_identifer + "priority", state=tk.HIDDEN
            )
            main_window.canvas.itemconfigure(
                transition_identifer + "rectangle", state=tk.HIDDEN
            )
        undo_handling.stack = []
        ...
        main_window.date_of_hdl_file_shown_in_hdl_tab = (
            update_ref.get_date_of_hdl_file()
        )
        main_window.date_of_hdl_file2_shown_in_hdl_tab = (
            update_ref.get_date_of_hdl_file2()
        )
