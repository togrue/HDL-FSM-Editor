...
def create_reset_entry(canvas_grid_coordinates_of_the_event):
    ...
    reset_entry_polygon = move_reset_entry_polygon_to_event(
...
def move_reset_entry_polygon_to_event(
    canvas_grid_coordinates_of_the_event, reset_entry_polygon
):
...
def move_to(event_x, event_y, polygon_id, first, last):
    ...
    new_upper_left_corner = calculate_new_upper_left_corner_of_the_polygon(
        event_x, event_y, width, height
    )
    new_upper_right_corner = calculate_new_upper_right_corner_of_the_polygon(
        event_x, event_y, width, height
    )
    new_point_right_corner = [event_x, event_y]
    new_lower_right_corner = calculate_new_lower_right_corner_of_the_polygon(
        event_x, event_y, width, height
    )
    new_lower_left_corner = calculate_new_lower_left_corner_of_the_polygon(
        event_x, event_y, width, height
    )
    new_coords = [
