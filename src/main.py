...
_style = ttk.Style(main_window.root)
...
_style.configure("Window.TFrame", background="blue")
_style.configure("Window.TMenubutton")
_style.configure("StateActionsWindow.TFrame", background="cyan2")
_style.configure("StateActionsWindow.TLabel", background="cyan2")
_style.configure("GlobalActionsWindow.TFrame", background="PaleGreen2")
_style.configure("GlobalActionsWindow.TLabel", background="PaleGreen2")
_style.configure("DefaultStateActions.TButton", background="cyan2")
_style.configure("GlobalActionsClocked.TButton", background="PaleGreen2")
_style.configure("GlobalActionsCombinatorial.TButton", background="PaleGreen2")
_style.configure("NewState.TButton", background="SkyBlue1")
_style.configure("NewTransition.TButton", background="white")
_style.configure("NewConnector.TButton", background="orchid1")
_style.configure("ResetEntry.TButton", background="IndianRed1")
_style.configure("View.TButton", background="lemon chiffon")
_style.configure("Undo.TButton")
_style.configure("Redo.TButton")
_style.configure("Find.TButton")
_style.configure("Path.TButton")
