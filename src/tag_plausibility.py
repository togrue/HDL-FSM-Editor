...
class TagPlausibility:
    ...
    def __init__(self) -> None:
        ...
        state_action_dict_list: list[dict[str, str]] = []
        state_action_line_dict_list: list[dict[str, str]] = []
        state_comment_dict_list: list[dict[str, str]] = []
        state_comment_line_dict_list: list[dict[str, str]] = []
        transition_dict_list: list[dict[str, Any]] = []
        connector_dict_list: list[dict[str, Any]] = []
    ...
    def __fill_dictionaries(
        ...
        state_comment_dict_list: list[dict[str, Any]],
        state_comment_line_dict_list: list[dict[str, str]],
    ) -> None:
