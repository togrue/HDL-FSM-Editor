        ...
        if lines[_line_index].startswith("state_number|"):
            ...
            for e in entries:
                try:
                    ...
                    polygon_tags = polygon_tags + (str(e),)
            ...
            notebook_id = main_window.canvas.create_rectangle(
                coords[0], coords[1], coords[2], coords[3], tags=rect_tags, fill=rectangle_color
            )
            ...
            for e in entries:
                try:
                    ...
                    comment_tags = comment_tags + (str(e),)
            comment_ref: state_comment.StateComment = state_comment.StateComment(
            ...
            for e in entries:
                try:
                    ...
                    ca_tags = ca_tags + (str(e),)
            connected_to_reset_entry = False
            for t in ca_tags:
                if t == "connected_to_reset_transition":
                    connected_to_reset_entry = True
            condition_action_ref: condition_action_handling.ConditionAction = condition_action_handling.ConditionAction(
            ...
            for e in entries:
                try:
                    ...
                    ga_tags = ga_tags + (str(e),)
            global_actions_ref: global_actions.GlobalActions = global_actions.GlobalActions(
            ...
            for e in entries:
                try:
                    ...
                    sad_tags = sad_tags + (str(e),)
            sad_action_ref: state_actions_default.StateActionsDefault = state_actions_default.StateActionsDefault(
                coords[0], coords[1], height=1, width=8, padding=1
            )
